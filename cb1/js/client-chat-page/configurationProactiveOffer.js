define(function (require, exports, module) {
    ...
    return function () { 
        ...
        var $closeButton = $offer.find('.proactive-offer__close.proactive-offer__button');
        var $close = $offer.find('.proactive-offer__close.close-icon');
        ...
        $closeButton.text(proActiveConfig.cancelButtonText);
