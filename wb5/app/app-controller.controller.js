angular.module('app')
    .controller('AppController', ['$scope','$window', '$http', '$timeout', '$parse', 'StatsApi', 'StyleApi', '$compile', 'WallboardStorage',

        function ($scope, $window, $http, $timeout, $parse, StatsApi, StyleApi, $compile, WallboardStorage) {
            ...
            $scope.dataGridAgent = {
                ...
                */
                ...
                active_item_media_type : "Active Media"
                //    acd_state: "ACD State",
            ...
            $scope.getAlertedStatus = function() {
                            
                var trigger = false;

                // Some conditions here switching trigger to TRUE
            ...
            function processGridData(widget, data_grids) {
                ...
                widget.config.subscription.req.columns.forEach(function (k) {
                  if (k.statName == "name" && widget.config.temptype == "agent_grid") {
                      var tempId = k.id;
                  ...
                  if(k.statName.includes("time") || k.statName.includes("duration")){
