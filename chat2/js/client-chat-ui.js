...
var appendLog = function(event) {
    ...
    if (e.msg) {
        ...
        var tmpl = '<div id="' + (event.msgId ? event.msgId : '') + '" class="new-msg-container ' + dir  +  ' new-msg-animate"><div class="pip"></div><div class="new-msg-body ' + dir +'">' +
            '<div class="new-msg-body-inner"><div class="new-msg-text " style="height: auto;"><div class="new-msg-text-inner">' + e. msg + '</div>' +
            '</div></div></div><div class="new-time">' + (fromClass !== 'sys' ? time : '') + '</div></div>';
