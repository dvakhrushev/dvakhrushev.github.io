(function() {
    ...
    var chatUrl = function() {
        ...
        return SP.chatPath + "client-chat-page.html?"
			...
			+ "&action2=" + encodeURIComponent(SP.action2 || '')
			+ "&first_name2=" + encodeURIComponent(SP.first_name2 || '')
			+ "&country=" + encodeURIComponent(SP.country || '')
			+ "&phone2=" + encodeURIComponent(SP.phone2 || '')
			+ "&phone_ext2=" + encodeURIComponent(SP.phone_ext2 || '')
			+ "&action3=" + encodeURIComponent(SP.action3 || '')
			+ "&first_name3=" + encodeURIComponent(SP.first_name3 || '');
